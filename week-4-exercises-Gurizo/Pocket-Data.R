...
# pocket_df <- Pudding.pockets.salty
pocket_df <- read.csv("/Users/taehwancho/Info201code/week-4-exercises-Gurizo/Pudding-pockets-salty.csv", stringsAsFactors = FALSE)
